...
fixed collection of distinct translation sites $a_1,\dots,a_N$, the first $N$
eigenvalues are
\[
...
Python~3.12.3, NumPy~1.26.4, and SciPy~1.11.4.  A frozen copy of the scripts,
pinned dependencies, release audit, and reference output is included in the
submission source package; this is the version corresponding to the manuscript.
The immutable repository tag for this version is
\texttt{paper-2026-09-01}.  The development repository is available at
