...
respectively.  The proof uses an exact central-inversion reduction, an
...
in the nonlocal Hong--Krahn--Szeg\H{o} minimizing sequence.  We also treat any
fixed finite family of identically oriented translates of a common well, without a
symmetry assumption.  For distinct sites $a_1,\ldots,a_N$, the first $N$
eigenvalues satisfy
...
$-c_{d,s}m_1^2\lvert a_i-a_j\rvert^{-d-2s}$.  Exact cell-integral Galerkin
computations on two and three intervals illustrate the fixed-mesh limits.
...
\end{equation}
Simplicity and central-inversion invariance show that
...
\]
The implicit constants in the two expansions are independent of $L$.
\end{corollary}
...
\[
 ...
 =c_{d,s}C_{\kappa,R}m_1^2L^{-\kappa-2}
  +\frac{2\beta_L^2}{g}.
\]
Moreover, $L\geq L_0$ implies $L\geq4R$ and $\gamma_L=\beta_L\leq g/4$,
...
max. error is measured against the corresponding effective-matrix spectrum.}
\label{tab:clusters}
\end{minipage}
\par\medskip
...
\texttt{paper-2026-09-04-r4}.  The tagged development source is available at
\href{https://github.com/skypher/laplace-tunneling/tree/paper-2026-09-04-r4}%
{github.com/skypher/laplace-tunneling/tree/paper-2026-09-04-r4}.
\end{sloppypar}
