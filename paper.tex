...
nonlocal Hong--Krahn--Szeg\H{o} minimizing sequence.  We also treat finitely
many congruent wells without a symmetry assumption.  For fixed distinct sites
$a_1,\ldots,a_N$, the first $N$ eigenvalues satisfy
...
We prove that two distant congruent components exhibit a nonzero splitting
that decays algebraically with their separation.
...
Second, we derive an explicit effective Hamiltonian for finitely many congruent
wells without a symmetry assumption.  Third, we give uniform spectral-cluster
errors and fixed-mesh computations illustrating both limits.
...
\texttt{paper-2026-09-04-r2}.  The tagged development source is available at
\href{https://github.com/skypher/laplace-tunneling/tree/paper-2026-09-04-r2}%
{github.com/skypher/laplace-tunneling/tree/paper-2026-09-04-r2}.
\end{sloppypar}
