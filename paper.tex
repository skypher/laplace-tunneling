...
\author{Leslie P. Polzer\\[4pt]
  {\normalfont\small Independent Researcher}\\[-1pt]
  {\normalfont\small
   \href{mailto:polzer@fastmail.com}{\texttt{polzer@fastmail.com}}}}
\date{August 2026}
...
The script \path{tools/check_asymptotics.py} is available in the public
\texttt{laplace-tunneling} repository on
\href{https://github.com/skypher/laplace-tunneling}{GitHub} and reconstructs
every entry in Tables~\ref{tab:mesh} and \ref{tab:clusters}.  It checks the
cell-integral identity before solving the eigenproblems and prints progress
after each separation.  The pinned numerical dependencies are listed in
