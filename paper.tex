...
interaction coefficient for the standard restricted fractional Laplacian.
...
standard restricted fractional Laplacian.  Zahl's discrete energy anticipates the
...
bounded by positive separation.  Each separate zero-exterior form already
contains the square interaction with the location occupied by the other
component.  Thus, after the above changes of variables, expanding the square
in \eqref{eq:form} gives exactly
\begin{align*}
...
normalized vector $\psi=a\phi+\eta$ in the operator domain of $A$,
...
citation and calculation audits, preparation of exact verification code, and
revision.  The author directed the research, selected and
...
submission source package; this is the version corresponding to the
manuscript.  The development repository is available at
